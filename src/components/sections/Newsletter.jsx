      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-spin-black text-white font-heading font-bold px-8 py-4 rounded-full hover:bg-spin-teal transition-all duration-300 flex items-center justify-center gap-3 focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
          >
