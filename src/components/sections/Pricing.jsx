...
const Pricing = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: 'Precisa de trazer a sua raquete de padel e roupa desportiva. Se não tiver raquete, oferecemos aluguer de raquetes. Vendemos bolas, grips e outro material desportivo na nossa loja.'
    },
    {
  ...
  return (
    <section id="precos" className="py-20 px-4 bg-spin-deep-blue">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="bg-spin-blue rounded-2xl p-8 text-center hover:scale-105 transition-transform duration-300 relative overflow-hidden">
            <h4 className="text-2xl font-bold text-white uppercase mb-4">Off-Peak</h4>
            <p className="text-white text-sm mb-6">07h00 - 17h00</p>
            <div className="text-6xl font-black text-white mb-2">€34</div>
            <p className="text-white/80 text-lg">1h30 de jogo</p>
            <div className="mt-6 pt-6 border-t border-white/20">
              <p className="text-white/70 text-xs">Horário da manhã e início da tarde</p>
            </div>
          </div>
          ...
          <div className="bg-spin-orange rounded-2xl p-8 text-center hover:scale-105 transition-transform duration-300 relative overflow-hidden">
            <h4 className="text-2xl font-bold text-white uppercase mb-4">Peak</h4>
            <p className="text-white text-sm mb-6">17h00 - 23h00</p>
            <div className="text-6xl font-black text-white mb-2">€46</div>
            <p className="text-white/80 text-lg">1h30 de jogo</p>
            <div className="mt-6 pt-6 border-t border-white/20">
              <p className="text-white/70 text-xs">Horário de fim de tarde e noite</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span>Cancelamento gratuito até 24h antes do jogo</span>
          </div>
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-spin-orange" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-white text-black font-heading font-bold px-12 py-4 rounded-full hover:bg-spin-orange hover:text-white transition-all duration-300 shadow-2xl uppercase inline-flex items-center gap-3 focus-visible:ring-2 focus-visible:ring-spin-orange focus-visible:outline-none"
          >
        ...
        <div className="lg:hidden grid grid-cols-1 md:grid-cols-2 gap-6">
          {pricingData.map((row, rowIndex) => (
            <motion.div
              ...
              className="bg-spin-black/40 rounded-2xl p-6 border border-white/10"
            >
                ...
                {row.players.map((player, playerIndex) => (
                  <div key={playerIndex} className="space-y-2">
                    <div className="inline-flex w-full justify-center">
                      <div className="text-center text-white text-xs font-medium bg-spin-black/40 rounded-full px-3 py-2 border border-white/20">
                        {player.count}
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-1">
                      <div className="bg-spin-orange rounded-lg p-3 text-center">
                        <div className="text-white font-bold text-base min-[375px]:text-lg">{player.peak}</div>
                      </div>
                      <div className="bg-spin-blue rounded-lg p-3 text-center">
                        <div className="text-white font-bold text-base min-[375px]:text-lg">{player.offPeak}</div>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="grid grid-cols-9 gap-4 mb-4">
              ...
              {['4 jogadores', '3 jogadores', '2 jogadores', '1 jogador'].map((players, index) => (
                <div key={index} className="col-span-2 text-center">
                  <div className="bg-spin-black/40 rounded-full py-3 px-4 border border-white/20 w-full flex items-center justify-center">
                    <h3 className="text-white font-bold text-sm">{players}</h3>
                  </div>
                </div>
              ))}
            </div>
            ...
            {pricingData.map((row, rowIndex) => (
              ...
              >
                ...
                <div className="col-span-1 flex items-center justify-center">
                  <div className="bg-spin-black/40 rounded-full py-3 px-4 border border-white/20 text-white font-bold text-sm w-full text-center">
                    {row.duration}
                  </div>
                </div>
