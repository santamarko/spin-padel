...
const Footer = () => {
  const socialLinks = [
    {
      ...
      url: 'https://instagram.com/spinpadel'
    },
    {
      name: 'Facebook',
      icon: (
  ...
  return (
    <footer className="bg-spin-black text-white">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          >
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              O teu clube de padel na Rinchoa. Campos de qualidade, ambiente descontraído e uma comunidade que partilha a paixão pelo jogo.
            </p>
            {/* Social Icons */}
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.path}
                    className="text-gray-400 hover:text-spin-orange transition-colors duration-300 text-sm"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          >
            ...
            <div className="mt-6 pt-6 border-t border-gray-800">
              <h5 className="text-white font-bold text-sm mb-3 uppercase tracking-wide flex items-center gap-2">
                <svg className="w-4 h-4 text-spin-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          >
            <p className="text-gray-500 text-sm">
              © 2025 Spin Padel. Todos os direitos reservados.
            </p>
            <p className="text-gray-600 text-xs">
              Feito com paixão pelo padel
            </p>
          </motion.div>
        </div>
      </div>
