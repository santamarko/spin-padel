      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-white text-black font-bold px-10 py-4 rounded-full hover:bg-spin-dark hover:text-white transition-all duration-300 shadow-2xl uppercase inline-flex items-center gap-3"
            >
        ...
        >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-white text-black px-6 py-2.5 rounded-full font-bold hover:bg-spin-orange hover:text-white transition-all duration-300 shadow-lg uppercase inline-flex items-center gap-2 focus-visible:ring-2 focus-visible:ring-spin-orange focus-visible:outline-none"
          >
