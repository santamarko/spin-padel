...
export default function NotFoundPage() {
  ...
  return (
    <div className="bg-spin-deep-blue min-h-screen flex items-center justify-center px-4">
      <SEO
        ...
        >
          <Link to="/">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-spin-orange text-white font-heading font-bold px-8 py-4 rounded-full hover:bg-white hover:text-spin-orange transition-all duration-300 shadow-lg uppercase"
            >
              Voltar ao Início
            </motion.button>
          </Link>
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-transparent border-2 border-white text-white font-heading font-bold px-8 py-4 rounded-full hover:bg-white hover:text-spin-dark transition-all duration-300 uppercase inline-flex items-center gap-2"
          >
